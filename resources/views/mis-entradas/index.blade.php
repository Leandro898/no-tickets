...
@section('content')
    <p class="text-gray-700 mb-6">
        Tus entradas han sido enviadas por correo electrónico al confirmar el pago. También podés verlas y descargarlas
        desde aquí.
    </p>
                ...
                @forelse($tickets as $ticket)
                    ...
                    *Podés descargar tu entrada en PDF desde este enlace:*",
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 align-middle">${{ number_format($ticket->order->total_amount, 0, ',', '.') }}
                        </td>
                        <td class="px-4 py-3 align-middle">{{ $ticket->short_code }}</td>
                        <td class="px-4 py-3 align-middle">
  ...
  "
        x-show="show" x-transition class="fixed top-6 right-6 z-50 min-w-[220px] px-6 py-4 rounded shadow-lg text-white"
        x-bind:class="{
