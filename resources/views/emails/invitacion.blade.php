...
<div style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="background:#ffffff;border-radius:8px;border:1px solid #e0dbf5;overflow:hidden;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
            <tr>
                {{-- DETALLES --}}
                <td style="background:#ffffff;padding:20px;vertical-align:top;font-size:14px;color:#555;line-height:1.6; text-align:center;">
                    ...
                    <ul style="list-style:none;padding:0;margin:0 0 20px 0;font-size:14px;line-height:1.6;color:#555; text-align:left;">
