  ...
  <div style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="background:#ffffff;border-radius:8px;border:1px solid #e0dbf5;padding:20px;margin-top:20px;">
      ...
      <ul style="font-size:14px;color:#555;line-height:1.6;margin:0 0 0 20px;padding:0;">
        <li style="margin-bottom:8px;">Presenta tu eTicket desde tu celular en la entrada.</li>
        <li style="margin-bottom:8px;">Puedes ver tus compras en cualquier momento en nuestra web.</li>
        <li style="margin-bottom:8px;">Mantén tus QR a mano y con buena iluminación.</li>
      </ul>
    </div>
