        ...
        <section>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
                @forelse($eventos as $evento)
                    ...
                    <a href="{{ $url }}"
                       class="evento-card bg-white rounded-2xl overflow-hidden shadow-md border border-gray-100 hover:-translate-y-2 transition">
                        <div class="evento-img w-full h-45 sm:h-52 md:aspect-video overflow-hidden bg-black flex items-center justify-center">
