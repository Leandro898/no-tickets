...
<x-filament::page>
    ...
    <div x-data="{ mostrarModal: false, mostrarToast: false }" class="">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 justify-items-center">
            ...
            <x-filament::button type="button" icon="heroicon-o-link"
        ...
        {{-- MODAL: Copiar enlace --}}
        <div x-show="mostrarModal" x-cloak x-transition:enter="transition ease-out duration-500"
            x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
            x-transition:leave="transition ease-in duration-500" x-transition:leave-start="opacity-100 scale-100"
            x-transition:leave-end="opacity-0 scale-90" @click.self="mostrarModal = false"
        ...
        <div x-show="mostrarToast" x-cloak x-transition.opacity.duration.700ms
            ...
            <span class="text-green-900 font-semibold tracking-wide select-none">
